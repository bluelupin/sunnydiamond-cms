export interface TryAtHomeReminderData {
...
export function tryAtHomeReminderTemplate(data: TryAtHomeReminderData) {
  ...
  const manageText = data.manageUrl
    ? ['', `Manage Appointment: ${data.manageUrl}`, 'If you need to reschedule or cancel your appointment, you can manage your appointment using the link above.'] : [];
  ...
  return {
    ...
    text: [
      ...
      'Selected Jewellery', '', ...products, '',
      'Please ensure that someone is available at the provided address during the scheduled appointment time.',
      ...manageText, '', 'We look forward to seeing you tomorrow.', '',
      'Warm regards,', 'Team Sunny Diamonds', 'Crafted to celebrate your moments',
    ].join('\n'),
    html: restyleSunnyEmail(`<!doctype html>
<html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>Try at Home appointment reminder</title></head>
<body style="margin:0;background:#f5f5f5;color:#222;font-family:Arial,sans-serif;line-height:1.6">
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0"><tr><td align="center" style="padding:24px 12px">
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:600px;background:#fff"><tr><td style="padding:32px">
      ...
      <h1 style="font-size:24px">Your Try at Home appointment is tomorrow</h1>
      <p>Dear ${escapeHtml(name)},</p>
      <p>Just a gentle reminder that your <strong>Sunny Diamonds Try at Home</strong> appointment is scheduled for tomorrow.</p>
      <p>We’re looking forward to bringing your selected jewellery to you and helping you experience it from the comfort of your home.</p>
      ...
      <ul>${products.map(product => `<li><strong>${escapeHtml(product)}</strong></li>`).join('')}</ul>
      <p>Please ensure that someone is available at the provided address during the scheduled appointment time.</p>
      ${manageHtml}
